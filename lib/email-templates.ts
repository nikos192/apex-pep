  ...
  <div class="container">
    ...
    <div class="section" style="background: #f9fafb; padding: 15px; border-radius: 8px;">
      ...
      ${
        ...
        <span class="detail-value">-$${payload.promoDiscount.toFixed(2)}</span>
      </div>`
          : ""
      }
      <div class="detail-row">
  ...
  <div class="container">
    ...
    <div class="section">
      ...
      <div class="bank-details">
        ...
        <div class="bank-value">APL</div>

        <div class="bank-label">BSB Number</div>
        <div class="bank-value">638-010</div>

        <div class="bank-label">Account Number</div>
        <div class="bank-value">15852423</div>
