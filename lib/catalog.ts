...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    bullets: [
      "30mg format for extended research protocols",
      "Triple receptor agonist research",
      "Studied in metabolic signaling investigations",
      "Research-grade lyophilized compound",
    ],
    storage: "Store at 2-8°C in a sealed container away from light. Protect from freezing. Reconstituted solutions should remain refrigerated.",
    shipping: "Express courier with temperature-controlled insulation. Delivery to major Australian cities within 1-2 business days.",
    dosageForm: "Lyophilized powder, 30mg per vial",
  },
  {
    id: "nad-plus-500mg",
    name: "NAD+ 500MG",
    ...
    bullets: [
      "500mg research format",
      "Studied in cellular energy pathway research",
      "Used in redox and metabolic investigations",
      "Suitable for controlled laboratory analysis",
    ],
    storage: "Store at 2-8°C in a tightly sealed container protected from light and moisture. Follow laboratory handling protocols after reconstitution.",
    shipping: "Express courier with protective insulated packaging. Delivery to major Australian cities within 1-2 business days.",
    dosageForm: "Research-grade powder, 500mg per vial",
  },
  {
    id: "bpc-157",
    name: "BPC-157",
...
export const BULK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    slug: "bulk-mega-deal",
    image: "/images/bulk mega deal.JPG",
    regularPrice: 1750,
    salePrice: 999,
    badge: "Mega Deal",
    description:
